...
export default function Header() {
  ...
  function changeArrowWithLink(id) {
    ...
    let all = [
      ...
      {
        text: "Manage my Nifts",
        link: "./signup",
      },
      {
        text: "Get news and updates ",
        link: "./signup",
      },
      {
    ...
    <header className="header" id="header_block">
      ...
      >
        <div className="header__logo">
          <a href="./" className="logo" title="Nift Corp">
            <img
              className="header__logo_image desktop"
              src="assets/img/brandLogo/nift_all_black.png"
              alt=""
            />
            <img
              className="header__logo_image desktop hover"
              src="assets/img/brandLogo/nift_all_color.png"
              alt=""
            />
            <img
              className="header__logo_image mobile"
              src="assets/img/brandLogo/favicon_all_black.png"
              alt=""
            />
            <img
              className="header__logo_image mobile hover"
              src="assets/img/brandLogo/faviconTransparent.png"
              alt=""
            />
          </a>{" "}
        </div>{" "}
        ...
        <nav className="header__menu desktop">
          <ul className="menu">
            ...
            <li className="menu__item">
              {" "}
              <a href="./#token" className="menu__link">
                {" "}
                Token{" "}
              </a>
            </li>
           ...
           {" "}
            {/* <li className="menu__item"><a href="/get_listed" target="_blank" className="menu__link">List Token <sup style={{fontStyle: "italic", color:'black'}}>FREE</sup></a></li> */}{" "}
          </ul>{" "}
        </nav>{" "}
        <nav className="header__menu desktop">
          <ul className="menu">
            <li className="menu__item">
              {" "}
              <a href="./signin" className="menu__link">
                {" "}
                Sign In{" "}
              </a>
            </li>
            <li className="menu__item menu__item_with_arrow getStartedBtn">
              <a
                href="./signup"
                className="menu__link menu__link_with_arrow"
                id="menu__link_with_arrow"
              >
                {" "}
                Get started{" "}
              </a>{" "}
              <svg
                ...
                viewBox="0 0 50 9"
                fill="none"
                class="css-yb3uov menu__item_arrow"
                style={{ color: "yellow" }}
                arrowWidth="15"
              >
                {" "}
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M46 0C47.5 4 50 4 50 4V5C50 5 47.5 5 46 9H45C45 8.27907 46.0395 6.2588 47.369 5H0V4H47.369C46.0395 2.7412 45 0.720928 45 0H46Z"
                  fill="#000"
                >
                  {" "}
                </path>
        ...
        >
          <span className="btn-menu-toggle__line btn-menu-toggle__line--top">
            {" "}
          </span>{" "}
          <span className="btn-menu-toggle__line btn-menu-toggle__line--center">
            {" "}
          </span>{" "}
          <span className="btn-menu-toggle__line btn-menu-toggle__line--bottom">
            {" "}
          </span>{" "}
        </button>{" "}
      </div>{" "}
